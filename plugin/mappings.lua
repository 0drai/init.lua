...
-- remap_default('n', '<localleader>fa', ':ALEFix<CR>')
-- remap_default('n','<c-h>', ':ALEPrevious<CR>')
-- remap_default('n','<c-l>', ':ALENext<CR>')
-- remap_default('n','<c-d>', ':ALEDetail<CR>')
...
telescope_remap('<leader>Z', 'find_files cwd=' .. '~/docs/zk')
